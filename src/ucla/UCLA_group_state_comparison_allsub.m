...
% for control subject
pc_global_con = computeDynamicNetworkMeasure(ucla_task(:, tp_idx, ...
    sub_idx_control), map268, 15, temporal_label);
...
figure;
subplot(1,2,1)
scatter3(dm_con(1, nonzero_pc_idx), dm_con(2, nonzero_pc_idx),...
    dm_con(3, nonzero_pc_idx), 40, pc_global_con(nonzero_pc_idx), 'filled');
